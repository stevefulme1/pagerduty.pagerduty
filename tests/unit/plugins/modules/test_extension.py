...
def _build_resource(**overrides):
    """Return a mock extension resource dict."""
    base = {
        "id": "P123ABC",
        "name": "test-resource",
        "type": "extension",
...
class TestCreate:
    ...
    def test_create_resource(self, mock_ansible_cls, mock_pd_cls, resource_args, mock_client):
        ...
        mock_client.post.return_value = {"extension": _build_resource()}
...
class TestUpdate:
    ...
    def test_update_resource(self, mock_ansible_cls, mock_pd_cls, resource_args, mock_client):
        ...
        mock_client.put.return_value = {"extension": _build_resource(name="updated-resource")}
