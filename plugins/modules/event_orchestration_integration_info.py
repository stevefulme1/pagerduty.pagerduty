...
DOCUMENTATION = r'''
---
module: event_orchestration_integration_info
short_description: List integrations for a PagerDuty event orchestration
description:
...
options:
  orchestration_id:
    ...
    required: true
seealso:
  - module: pagerduty.pagerduty.event_orchestration_integration
notes:
...
- name: List all integrations
  pagerduty.pagerduty.event_orchestration_integration_info:
