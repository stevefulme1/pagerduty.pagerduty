...
DOCUMENTATION = r'''
---
module: event_orchestration_service_rule_info
short_description: List service rules for a PagerDuty event orchestration
description:
...
EXAMPLES = r'''
- name: List all rules
  pagerduty.pagerduty.event_orchestration_service_rule_info:
