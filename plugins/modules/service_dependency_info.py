...
DOCUMENTATION = r'''
---
module: service_dependency_info
short_description: List service dependencies in PagerDuty
description:
  - Retrieve information about PagerDuty relationships.
...
options:
  service_id:
    description: The ID of the service to get dependencies for.
    type: str
    required: true
seealso:
  - module: pagerduty.pagerduty.service_dependency
notes:
...
- name: List all relationships
  pagerduty.pagerduty.service_dependency_info:
...
def main():
    ...
    try:
        qp = {}
        data = client.list_all('/service_dependencies/technical_services/' + params['service_id'], 'relationships', params=qp or None)
        module.exit_json(changed=False, relationships=data, count=len(data))
