...
DOCUMENTATION = r'''
---
module: incident_note_info
short_description: List notes for a PagerDuty incident
description:
  - Retrieve information about PagerDuty notes.
...
options:
  incident_id:
    ...
    required: true
seealso:
  - module: pagerduty.pagerduty.incident_note
notes:
...
EXAMPLES = r'''
- name: List all notes
  pagerduty.pagerduty.incident_note_info:
...
def main():
    ...
    try:
        qp = {}
        data = client.list_all('/incidents/' + params['incident_id'] + '/notes', 'notes', params=qp or None)
        module.exit_json(changed=False, notes=data, count=len(data))
