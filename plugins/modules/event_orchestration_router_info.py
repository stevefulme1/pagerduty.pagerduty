...
DOCUMENTATION = r'''
---
module: event_orchestration_router_info
short_description: List router rules for a PagerDuty event orchestration
description:
...
options:
  orchestration_id:
    ...
    required: true
seealso:
  - module: pagerduty.pagerduty.event_orchestration_router
notes:
...
EXAMPLES = r'''
- name: List all rules
  pagerduty.pagerduty.event_orchestration_router_info:
...
def main():
    ...
    try:
        qp = {}
        data = client.list_all('/event_orchestrations/' + params['orchestration_id'] + '/router', 'rules', params=qp or None)
